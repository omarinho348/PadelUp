...
<head>
    ...
    <link rel="stylesheet" href="styling/coach-finder.css">
</head>
<body>
    ...
    <div class="container">
        <div class="coaches-grid">
            ...
            <div class="coach-card">
                <div class="coach-image" style="background-image: url('Assets/Photos/Coach1.jpg');"></div>
            ...
            <!-- Coach Card 2 -->
            <div class="coach-card">
                <div class="coach-image" style="background-image: url('Assets/Photos/coach2.webp');"></div>
                <div class="coach-info">
            ...
            <!-- Coach Card 3 -->
            <div class="coach-card">
                <div class="coach-image" style="background-image: url('Assets/Photos/coach3.jpg');"></div>
                <div class="coach-info">
            ...
            <!-- Coach Card 4 -->
            <div class="coach-card">
                <div class="coach-image" style="background-image: url('Assets/Photos/coach4.webp');"></div>
                <div class="coach-info">
            ...
            <!-- Coach Card 5 -->
            <div class="coach-card">
                <div class="coach-image" style="background-image: url('Assets/Photos/coach5.jpg');"></div>
                <div class="coach-info">
            ...
            <!-- Coach Card 6 -->
            <div class="coach-card">
                <div class="coach-image" style="background-image: url('Assets/Photos/coach6.webp');"></div>
                <div class="coach-info">
