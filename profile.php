                ...
                <div class="profile-details">
                    ...
                    <div class="profile-stats">
                        <div class="stat">
                            ...
                            <span class="stat-value"><?php echo ucfirst(htmlspecialchars($_SESSION['SkillLevel'])); ?></span>
                        </div>
                        <div class="stat">
                            <span class="stat-label">Location</span>
                            <span class="stat-value"><?php echo htmlspecialchars($_SESSION['Location']); ?></span>
                        </div>
                        <?php if(isset($_SESSION['Gender'])): ?>
                        <div class="stat">
                            <span class="stat-label">Gender</span>
                            <span class="stat-value"><?php echo ucfirst(htmlspecialchars($_SESSION['Gender'])); ?></span>
                        </div>
                        <?php endif; ?>
                    </div>
                </div>
